-- MIGRACIÓN PARA SEPARAR EL COSTO DE ENVÍO DE LAS GANANCIAS DEL RESTAURANTE
-- Este script agrega la columna delivery_fee a la tabla orders y actualiza el RPC place_order_secure

-- 1. Agregar columna delivery_fee si no existe
DO $$ 
BEGIN 
...
-- 2. Actualizar la función place_order_secure para manejar delivery_fee y campos de envío correctamente
...
BEGIN
    ...
    INSERT INTO public.orders (
        ...
        (p_order->>'shipping_lat')::numeric,
        (p_order->>'shipping_lng')::numeric,
        p_order->>'shipping_reference',
